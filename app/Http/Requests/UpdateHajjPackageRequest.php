...
use App\Models\HajjPackageImage;
...
class UpdateHajjPackageRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'slug' => ['required', 'string', 'max:255', Rule::unique('hajj_packages', 'slug')->ignore($packageId)],
            ...
            'existing_gallery_image_ids.*' => ['integer', 'exists:hajj_package_images,id'],
    ...
    public function withValidator($validator): void
    {
        $validator->after(function ($validator) {
            ...
            if ($existingImageIds !== []) {
                $ownedCount = HajjPackageImage::query()
                    ->whereIn('id', $existingImageIds)
                    ->where('hajj_package_id', $packageId)
                    ->count();
