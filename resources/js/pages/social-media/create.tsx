...
import { type BreadcrumbItem, type SocialMediaFormData } from '@/types';
...
export default function CreateSocialMedia() {
    const { data, setData, post, processing, errors } = useForm<SocialMediaFormData>({
        name: '',
        url: '',
        icon: null,
        is_active: true,
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 p-4">
                ...
                <Card className="mx-auto w-full max-w-2xl">
                    <CardHeader>
                        <CardTitle>Create New Social Media</CardTitle>
                        <CardDescription>
                            Add a new social media link to display on the website
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
